...
SRC_SCRIPT="${REPO_DIR}/cobs.sh"
DST_SCRIPT="${BIN_DIR}/cobs.sh"

echo "[install] Installing cobs…"
...
missing=()
command -v obsidian >/dev/null || missing+=("obsidian")
...
echo "[install] Done! Run 'cobs.sh' from the terminal you want on the right third."
